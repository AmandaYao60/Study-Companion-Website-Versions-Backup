      ...
      <div className="mb-4 flex items-start justify-between gap-3">
        <div>
          <h2 className="text-sm font-bold uppercase tracking-wider text-white">
            {isActive ? "Provisional Observed Study Signals" : "Observed Study Signals"}
          </h2>
          <p className="mt-1 text-xs text-slate-500">
            {isActive ? "This session is still in progress. Final observed-signal summary is generated after ending the session." : "Summary of model-estimated study signals generated by the session domain layer."}
          </p>
        </div>
