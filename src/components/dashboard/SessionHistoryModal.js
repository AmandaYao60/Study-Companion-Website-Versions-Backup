...
import LearnerObservedSignalsPanel from "./LearnerObservedSignalsPanel";
        ...
        {isLoading || !session ? (
          ...
          <div className="space-y-5">
            ...
            <div className="rounded-xl border border-white/10 bg-slate-900/35 p-4">
              <h3 className="text-sm font-bold uppercase tracking-wider text-white">Observed Study Signals</h3>
              <p className="mt-1 text-xs leading-relaxed text-slate-500">
                Summary of model-estimated study signals generated by the session domain layer.
              </p>
            ...
            <LearnerObservedSignalsPanel session={session} variant="modal" />
